...
import { Moblie } from './pages/tags/moblie';
import { NS } from './pages/tags/NS';
import { Playstation } from './pages/tags/playstation';
import { RatingGames } from './pages/rating';
    ...
    <div className="App">
      <BrowserRouter>
        <Routes>
          ...
          <Route path='/navbar' element={ React.createElement(Navbar, {loggedInStatus, user, setLoggedInStatus, setUser})} />
          <Route path='/mobile' element={ React.createElement(Moblie, {loggedInStatus}) } />
          <Route path='/switch' element={ React.createElement(NS, {loggedInStatus}) } />
          <Route path='/playstation' element={ React.createElement(Playstation, {loggedInStatus}) } />
          <Route path='/rating' element={ React.createElement(RatingGames, {loggedInStatus, user, setLoggedInStatus, setUser}) } />
